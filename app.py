...
# Configuration
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://admin:Ut2DBsHFM1JZEdEr8mvn@database-1.cp8osk6oad8n.ap-south-1.rds.amazonaws.com/stocker'  # Replace 'user', 'password', 'localhost', and 'db_name' with your actual MySQL credentials and database name
